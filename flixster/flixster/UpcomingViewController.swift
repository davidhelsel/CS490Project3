...
class UpcomingViewController: UIViewController, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "UpcomingCell", for: indexPath) as! PosterCell
        ...
        Nuke.loadImage(with: one!, into: cell.upcomingImage)
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://api.themoviedb.org/3/movie/top_rated?api_key=cf62b834e0066d428dfedc5f4200b7a0")!
